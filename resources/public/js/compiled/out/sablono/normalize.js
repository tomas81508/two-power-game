...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__21882){
var vec__21883 = p__21882;
var _ = cljs.core.nth.call(null,vec__21883,(0),null);
var v = cljs.core.nth.call(null,vec__21883,(1),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__21886_SHARP_){
return (((p1__21886_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__21886_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__21887,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__21887;
}
});
...
var G__21889 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__21889,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__21889;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq21888){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21888));
});
...
var tag_name = cljs.core.nth.call(null,vec__21895,(0),null);
var names = cljs.core.nth.call(null,vec__21895,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__21895,tag_name,names){
return (function (p1__21893_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__21893_SHARP_))){
return p1__21893_SHARP_;
} else {
return null;
}
});})(matches,vec__21895,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__21895,tag_name,names){
return (function (p1__21894_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__21894_SHARP_));
});})(matches,vec__21895,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__21898){
var vec__21899 = p__21898;
var seq__21900 = cljs.core.seq.call(null,vec__21899);
var first__21901 = cljs.core.first.call(null,seq__21900);
var seq__21900__$1 = cljs.core.next.call(null,seq__21900);
var tag = first__21901;
var content = seq__21900__$1;
...
var vec__21902 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21902,(0),null);
var id = cljs.core.nth.call(null,vec__21902,(1),null);
var class$ = cljs.core.nth.call(null,vec__21902,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1543694768788
