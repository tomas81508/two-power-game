...
var o25329 = temp__5455__auto__;
var temp__5455__auto____$1 = (o25329["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25330 = temp__5455__auto____$1;
return (o25330["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24895__auto__ = f;
return (o__24895__auto__["toString"]).call(o__24895__auto__);
} else {
return "";
}
}catch (e25331){var _ = e25331;
return "";
}});
...
try{var o__24895__auto___25333 = t;
(o__24895__auto___25333["cljs$lang$ctorPrWriter"]).call(o__24895__auto___25333,t,writer);
}catch (e25332){var __25334 = e25332;
}
...
var char_code = (function (){var o__24895__auto__ = (new String(char$));
return (o__24895__auto__["charCodeAt"]).call(o__24895__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24895__auto__ = String;
return (o__24895__auto__["fromCharCode"]).call(o__24895__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25335 = num_code;
switch (G__25335) {
case (1):
return (185);
...
var o__24895__auto__ = String;
return (o__24895__auto__["fromCharCode"]).call(o__24895__auto__,superscript_code);
});
/**
...
}catch (e25337){var _e__24902__auto__ = e25337;
return false;
}})())){
...
var vec__25338 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25338,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o25341 = temp__5455__auto__;
var temp__5455__auto____$1 = (o25341["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25342 = temp__5455__auto____$1;
return (o25342["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___25349 = arguments.length;
var i__4532__auto___25350 = (0);
while(true){
if((i__4532__auto___25350 < len__4531__auto___25349)){
args__4534__auto__.push((arguments[i__4532__auto___25350]));

var G__25351 = (i__4532__auto___25350 + (1));
i__4532__auto___25350 = G__25351;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25345){
var vec__25346 = p__25345;
var ns_detector = cljs.core.nth.call(null,vec__25346,(0),null);
...
var G__25352 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25353 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25352;
remaining_tokens = G__25353;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25343){
var G__25344 = cljs.core.first.call(null,seq25343);
var seq25343__$1 = cljs.core.next.call(null,seq25343);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25344,seq25343__$1);
});
...
var vec__25357 = cljs.core.split_with.call(null,(function (p1__25356_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25356_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25357,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25357,(1),null);
...
var vec__25360 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25360,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25360,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25363 = cljs.core.rest.call(null,remaining_tokens);
var G__25364 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25363;
name_tokens = G__25364;
continue;
} else {
...
var vec__25367 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25367,(0),null);
var arity = cljs.core.nth.call(null,vec__25367,(1),null);
var vec__25370 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25370,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25370,(1),null);
var vec__25373 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25373,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25373,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25373,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25373,(3),null);
...
var vec__25379 = result;
var munged_ns = cljs.core.nth.call(null,vec__25379,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25379,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25379,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25379,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25379,(4),null);
var arity = cljs.core.nth.call(null,vec__25379,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__25383 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__25383,(0),null);
var args = cljs.core.nth.call(null,vec__25383,(1),null);
var vec__25386 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25386,(0),null);
var name = cljs.core.nth.call(null,vec__25386,(1),null);
...
var G__25389 = (arity + (1));
var G__25390 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25391){
var vec__25392 = p__25391;
var arity = cljs.core.nth.call(null,vec__25392,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25392,(1),null);
...
return cljs.core.get.call(null,arities,p1__25395_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25396_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25399){
var vec__25400 = p__25399;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25400,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25397){
...
var G__25406 = arg;
var G__25406__$1 = (((G__25406 instanceof cljs.core.Keyword))?G__25406.fqn:null);
switch (G__25406__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25408__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25408__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25408__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25408__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25409 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25409,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25409,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25409,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25409,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25409,(4),null);
var arity = cljs.core.nth.call(null,vec__25409,(5),null);
...
var o__24895__auto__ = f;
return (o__24895__auto__["getBasis"]).call(o__24895__auto__);
});
/**
...
}catch (e25413){var _e__24902__auto__ = e25413;
...
var G__25414 = (obj[cljs.core.first.call(null,path)]);
var G__25415 = cljs.core.rest.call(null,path);
obj = G__25414;
path = G__25415;
continue;
} else {
...
return (function (accum,p__25416){
var vec__25417 = p__25416;
var bit = cljs.core.nth.call(null,vec__25417,(0),null);
var protocol = cljs.core.nth.call(null,vec__25417,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25420){
var vec__25421 = p__25420;
var ns = cljs.core.nth.call(null,vec__25421,(0),null);
var name = cljs.core.nth.call(null,vec__25421,(1),null);
var selector = cljs.core.nth.call(null,vec__25421,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__25426,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25426,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25426,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25424_SHARP_){
return (obj[cljs.core.first.call(null,p1__25424_SHARP_)]);
});})(name,sorted_matches,vec__25426,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1543694771815
