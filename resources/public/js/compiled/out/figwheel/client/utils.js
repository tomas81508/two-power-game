...
return (new CustomEvent(event_name,(function (){var obj31105 = {"detail":data};
return obj31105;
})()));
} else {
...
var f = (function (){var pred__31112 = cljs.core._EQ_;
var expr__31113 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31112.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31113))){
return ((function (pred__31112,expr__31113){
return (function (p1__31106_SHARP_){
return console.warn(p1__31106_SHARP_);
});
;})(pred__31112,expr__31113))
} else {
if(cljs.core.truth_(pred__31112.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31113))){
return ((function (pred__31112,expr__31113){
return (function (p1__31107_SHARP_){
return console.debug(p1__31107_SHARP_);
});
;})(pred__31112,expr__31113))
} else {
if(cljs.core.truth_(pred__31112.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31113))){
return ((function (pred__31112,expr__31113){
return (function (p1__31108_SHARP_){
return console.error(p1__31108_SHARP_);
});
;})(pred__31112,expr__31113))
} else {
return ((function (pred__31112,expr__31113){
return (function (p1__31109_SHARP_){
return console.log(p1__31109_SHARP_);
});
;})(pred__31112,expr__31113))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31116){
...
var eval_fn = cljs.core.get.call(null,map__31117__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31119_SHARP_);
});})(new_def))
);
...
return (function (p__31120){
var vec__31121 = p__31120;
var ky = cljs.core.nth.call(null,vec__31121,(0),null);
var v = cljs.core.nth.call(null,vec__31121,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1543694781733
